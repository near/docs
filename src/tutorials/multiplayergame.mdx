...
Click "Test". It should open a new window and show the test results using the standard Jasmine browser UI.
...
The game should now work and show the UI in nearstudio. To run the UI, use the "Run" button.
