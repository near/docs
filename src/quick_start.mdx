...
#### Option A: Deploy to our hosted DevNet

Deploy your contract to the same DevNet which the NEAR Studio IDE deploys to.

TODO.

#### Option B: Deploy to your local DevNet

This is more advanced -- you will need to build and run a local node. See the following section for how to do this.

Once you have a DevNet node running locally
...
Try submitting transactions or views via [JSON RPC](https://www.jsonrpc.org/specification). There is a Python script that wraps the RPC:
