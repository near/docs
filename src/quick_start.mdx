...
In the bottom right sub-window you can see the application running. It's using blockchain as the backend.

The code that runs on blockchain is in `assembly/main.ts` file. The javascript client is in `src/main.js` file. UI is in `src/main.html file`.
