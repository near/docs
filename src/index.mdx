...
The Introduction section will get you quickly up to speed on the basic concepts and functions you need to write and interact with contracts plus provide you with a FAQ section for the technical aspects of this project.
