...
Please visit [the contribution overview](/docs/community/contribution/contribution-overview) for more information.
...
When opening a pull request, please use the typical open-source flow of forking the desired repository and opening a pull request from your forked repository. (More information on [technical contributions here](/docs/community/contribution/technical-contribution).)
