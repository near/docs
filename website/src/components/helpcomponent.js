        ...
        <details>
          <summary>
            <b style={{ cursor: 'pointer' }}>
              Need some help? <a>Chat with us</a>
            </b>{' '}
            or check our <a href="/help">Dev Resources</a>!
          </summary>
          ...
          <div class="row mb-1">
            ...
            <div class="col col--3">
              <div className="avatar">
                ...
                <div className="avatar__intro">
                  <div className="avatar__name">
                    <a href="https://near.chat" target="_blank" rel="noopener noreferrer">
                      Discord
                    </a>
                  </div>
                </div>
            ...
            <div class="col col--3">
              <div className="avatar">
                ...
                <div className="avatar__intro">
                  <div className="avatar__name">
                    <a href="https://near.zulipchat.com/" target="_blank" rel="noopener noreferrer">
                      Zulip
                    </a>
                  </div>
                </div>
