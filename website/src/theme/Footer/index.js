              ...
              <div className="row">
                <div className="col sm:w-1/3 mt-50">
                  <h2 className="text-24 font-black text-blue-light">
                    <a href="/protocol/basics">Concepts</a>
                  </h2>
                  <ul
                    id="menu-concepts-1"
                  ...
                  >
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/protocol/basics">What is Near?</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/protocol/account-model">Accounts</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/protocol/transactions">Transactions</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/protocol/data-flow/near-data-flow">Data Flow</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/protocol/network/tokens">Token</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/protocol/storage/storage-staking">Storage</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/protocol/network/validators">Validators</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/chain-abstraction/what-is">Chain Abstraction</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/protocol/data-flow/near-data-flow">Data on Blockchain</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/protocol/network/runtime">Runtime</a>
                    </li>
                  </ul>
                </div>
                <div className="col sm:w-1/3 mt-50">
                  <h2 className="text-24 font-black text-blue-light">
                    <a href="/smart-contracts/quickstart">Build</a>
                  </h2>
                  <ul id="menu-build-1" className="footer-menu list-reset mt-5 text-16 md:text-16">
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/chain-abstraction/what-is">Chain Abstraction</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/smart-contracts/what-is">Smart Contracts</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/web3-apps/what-is">Web3 Apps</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/primitives/what-is">Primitives</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/chain-abstraction/intents/overview">Intents</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/data-infrastructure/what-is">Data Infrastructure</a>
                    </li>
                  </ul>
                </div>
                <div className="col sm:w-1/3 mt-50">
                  <h2 className="text-24 font-black text-blue-light">
                    <a href="/tutorials/welcome">Tutorials</a>
                  </h2>
                  <ul
                    id="menu-tutorials-1"
                    className="footer-menu list-reset mt-5 text-16 md:text-16"
                  >
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/tutorials/examples/count-near">Smart Contract</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/tutorials/nfts/minting-nfts">Mint NFTs</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/tutorials/fts/introduction">FTs</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                ...
                <div className="col sm:w-1/3 mt-50">
                  <h2 className="text-24 font-black text-blue-light">
                    <a href="/api/rpc/introduction">RPC</a>
                  </h2>
                  <ul id="menu-rpc-1" className="footer-menu list-reset mt-5 text-16 md:text-16">
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/api/rpc/providers">RPC Providers</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/api/rpc/setup">Setup</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/api/rpc/access-keys">Access Keys</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/api/rpc/contracts">Contracts</a>
                    </li>
                  </ul>
                </div>
                <div className="col sm:w-1/3 mt-50">
                  <h2 className="text-24 font-black text-blue-light">
                    <a href="/tools/welcome">Tools</a>
                  </h2>
                  <ul id="menu-rpc-1" className="footer-menu list-reset mt-5 text-16 md:text-16">
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/tools/near-api">API</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/tools/sdk">SDK</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/tools/near-cli">CLI</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/tools/wallet-selector">Wallet Selector</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/chain-abstraction/fastauth-sdk">FastAuth</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/chain-abstraction/relayers">Relayers</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a
                    ...
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/tools/explorer">Explorers</a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2045">
                      <a href="/tools/indexing">Indexing</a>
                    </li>
                  </ul>
                </div>
                <div className="col sm:w-1/3 mt-50">
                  <h2 className="text-24 font-black text-blue-light">Resources</h2>
                  <ul
                  ...
                  >
                    ...
                    <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-2945">
                      <a target="_blank" rel="noopener noreferrer" href="https://near.org/founders">
                        Startup Accelerator
                      </a>
                    </li>
                    <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-6804">
                      <a href="https://gov.near.org" target="_blank" rel="noopener noreferrer">
                        Forum
                      </a>
                    </li>
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-441">
                      <a href="https://near.org/about" target="_blank" rel="noopener noreferrer">
                        About Us
                      </a>
                    </li>
                    ...
                    <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-3267">
                      <a href="https://near.org/privacy" target="_blank" rel="noopener noreferrer">
                        Privacy Policy
                      </a>
                    </li>
                  </ul>
