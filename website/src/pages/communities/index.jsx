...
const CommunitiesPage = () => {
    ...
    const handleCommunityClick = (community) => {
        ...
        if (community.telegram) {
            window.open(`https://t.me/${community.telegram}`, '_blank');
        }
    };
            ...
            <section className="container-communities">
                <div className="main-card">
                    ...
                    <div className="channels-section">
                        ...
                        <div className="channels-grid">
                            ...
                            <a href="#" className="channel-item">
                                <span className="channel-item__icon">✖️</span>
                ...
                <div className="sidebar">
                    <div className="sidebar-card sidebar-card--purple">
                        ...
                        <a href="#" className="sidebar-card__button">
                            <span className="sidebar-card__button-icon">💬</span>
                            Join our Discord
                        </a>
                    </div>
