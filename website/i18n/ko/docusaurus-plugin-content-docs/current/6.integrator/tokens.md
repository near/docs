---
id: fungible-tokens
title: 대체 가능한 토큰 (Fungible Token)
...
기본적인 대체 가능한 토큰은 단순한 스마트 컨트랙트입니다. 간단한 예시를 들면, 이 컨트랙트는 자유 형식의 텍스트를 저장할 수 있는 스마트 컨트랙트와 비교했을 때 가변 스토리지가 없는 형태를 가지고 있습니다. 이 경우 필요한 스토리지는 오직 계정 키-값 쌍을 위한 공간이며, 항상 `1250000000000000000000` yoctoⓃ 만큼의 스토리지 보증금으로 처리됩니다.
