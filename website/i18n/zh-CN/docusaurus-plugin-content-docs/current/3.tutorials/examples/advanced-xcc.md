...
This example presents 3 instances of complex cross-contract calls. Particularly, it shows: Particularly, it shows:
...
This example is a particular case of the previous one ([Calling Multiple Contracts](#2-calling-multiple-contracts)). It simply showcases a different way to check the results by directly accessing the `promise_result` array.
