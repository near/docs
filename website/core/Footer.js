      ...
      <div className="bg-black-25 py-20 md:py-30">
        <div className="container max-w-none xl:flex justify-between items-center">
          ...
          <ul className="md:flex list-reset w-100p xl:w-auto mt-15 xl:mt-0">
            ...
            <li className="md:ml-50 sm:w-100p"><a href="https://wallet.testnet.nearprotocol.com/" target="_blank"><img src="https://nearprotocol.com/wp-content/themes/near-19/assets/img/logo-wallet.svg?t=1562679714" className="locked py-10" alt="NEAR Wallet" /></a></li>
            <li className="md:ml-50 sm:w-100p"><a href="https://explorer.testnet.nearprotocol.com" target="_blank"><img src="https://nearprotocol.com/wp-content/themes/near-19/assets/img/logo-explorer.svg?t=1562679714" className="locked py-10" alt="NEAR Explorer" /></a></li>
          </ul>
