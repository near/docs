...
- [SDK Types](/smart-contracts/anatomy/functions#sdk-types)
...
You can read more about the contract's interface and data types in our [contract functions documentation](/smart-contracts/anatomy/functions).
