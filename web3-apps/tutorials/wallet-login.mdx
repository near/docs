...
title: Web Login
icon: wallet
description: "Connect users to NEAR — via wallet or social/email login"
---
...
[Privy](https://www.privy.io/) allows users to log in using their email or social accounts (Google, GitHub, etc.). Upon login, a NEAR embedded wallet is automatically created for the user — no browser extension required.

<Tip>

**Example**

We have a [working example](https://github.com/near-examples/hello-privy), which you can get through `create-near-app`:
