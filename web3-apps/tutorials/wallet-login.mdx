...
title: Wallet Login
icon: wallet
description: "Enable users to login with their NEAR wallet"
---
...
Before sending a transaction to a user-typed account, validate the recipient. See [Validating Recipient Accounts](./validate-recipient) for the existence check, typo detection, and confirmation patterns used by the major NEAR wallets.
