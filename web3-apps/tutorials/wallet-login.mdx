...
Thanks to [NEP-516](https://github.com/near/NEPs/pull/555) Ethereum wallets can control `0x...` accounts on NEAR Protocol.

To enable Ethereum wallets on `near-connect` simply add the `evm-on-near` wallet manifest:
