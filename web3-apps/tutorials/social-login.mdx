...
**Choose it when** you want one wallet usable across several dApps, or you already speak `near-connect` and want Privy to be just another wallet in the selector.
