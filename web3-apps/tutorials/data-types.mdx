...
Check the [Smart Contract SDK Types](/smart-contracts/anatomy/functions#sdk-types) section for more information on how to handle data types within smart contracts.
