...
Smart contracts are written in [TypeScript](../../the_basics/language-typescript.md). Here is the API reference for the runtime. Note that it's in active development, so please add an issue on Github if this is out of date and we'll fix it right away!
...
**● DATA\_TYPE\_CURRENT\_ACCOUNT\_ID**: [_DataTypeIndex_](_near_.md#datatypeindex) = 2
...
**● DATA\_TYPE\_INPUT**: [_DataTypeIndex_](_near_.md#datatypeindex) = 4
...
**● DATA\_TYPE\_ORIGINATOR\_ACCOUNT\_ID**: [_DataTypeIndex_](_near_.md#datatypeindex) = 1
...
**● DATA\_TYPE\_RESULT**: [_DataTypeIndex_](_near_.md#datatypeindex) = 5
...
**● DATA\_TYPE\_STORAGE**: [_DataTypeIndex_](_near_.md#datatypeindex) = 3
...
**● DATA\_TYPE\_STORAGE\_ITER**: [_DataTypeIndex_](_near_.md#datatypeindex) = 6
...
**● context**: [_Context_](../classes/_near_.context.md) = new Context\(\)
...
**● storage**: [_Storage_](../classes/_near_.storage.md) = new Storage\(\)
