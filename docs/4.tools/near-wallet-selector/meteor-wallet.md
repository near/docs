...
- `iconUrl`: (`string?`): Image URL for the icon shown in the modal. This can also be a relative path or base64 encoded image. Defaults to [`/assets/meteor-icon.png`](https://github.com/near/wallet-selector/tree/main/packages/meteor-wallet/assets/meteor-icon.png).

## Assets

Assets such as icons can be found in the [`/assets`](https://github.com/near/wallet-selector/tree/main/packages/meteor-wallet/assets) directory of the package. Below is an example using Webpack:
