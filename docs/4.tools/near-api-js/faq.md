...
After [contract is instantiated](quick-reference.md#load-contract-load-contract) you can then call the contract and specify the amount of attached gas.
...
You maybe using a KeyStore that's for the browser. Instead use a filesystem key or private key string. [See methods here](quick-reference.md#key-store-key-store)
