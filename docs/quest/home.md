...
<Card color="mint" className="no-border no-shadow center-content">
    <div class="row">
        <div class="col">
            <img src="/assets/docs/quest/landing.png" alt="NEAR Quest Illustration"/>
        </div>
        <div class="col col--5" style={{display: 'flex', alignItems: 'center'}}>
            <div class="center-content">
                <p className="quest-subtitle">Welcome to</p>
                <h1 className="quest-title" style={{marginBottom: "0.5rem"}}>NEAR Quest</h1>
                <p className="quest-subtitle">an interactive journey to master NEAR Protocol</p>
                <p className="quest-subsection">
                    Learn through hands-on challenges about:
                </p>
                <ul class="quest-list">
                    <li> Protocol Fundamentals </li>
