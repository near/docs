...
- For `near-api-js` installation and setup please refer to `near-api-js` [quick reference documentation](../../3.tools/near-api-js/quick-reference.md).
- All JavaScript code snippets below require a `near` object. For examples of how to instantiate, [ [**click here**](../../3.tools/near-api-js/quick-reference.md#connect-connect).
