...
If you are ready to dive straight into application and smart contract development, we recommend skimming this page and then heading directly to [the Develop section](/docs/develop/basics/getting-started).
...
2. **To run a validating node,** which means taking part in the operation of the core network itself, see [running a testnet node](/docs/develop/node/running-a-node) or, for a full staking overview, see [the staking overview](/docs/validator/staking-overview). This is not necessary for developing smart contracts or apps but it can be a good way to feel connected to the "bare metal" of how the network works.
...
4. **To contribute to the core code base yourself,** see [contributing to NEAR](/docs/community/contribution/contribution-overview). To suggest changes to these docs, [view them on Github](https://github.com/near/docs) or just click the "Edit" button in the top to get started submitting your pull request.
...
* [AssemblyScript Contracts](/docs/develop/contracts/as/intro) -- covers the same topic, but for AssemblyScript
* [RPC](/docs/develop/front-end/rpc) -- covers the actual core API responses and actions you can call
* [near-api-js](/docs/front-end/near-api-js) -- is autogenerated documentation for the JavaScript integration library
* [Rust Contracts](/docs/develop/api/near-sdk-rs) -- covers the API for creating apps with Rust
...
To find more about on how YOU can get involved, please checkout our [community section](/docs/community/contribution/nearcore)!
