...
* Using [`near-sdk-as`](https://near.github.io/near-sdk-as), import `env` and check `env.storage_usage()` – [example](https://github.com/near/near-sdk-as/blob/f72b3d70cee8af573677b3d1d1e687b26543f96/assembly/__tests__/runtime/runtime.spec.ts#L82-L111)
