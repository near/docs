...
description: "Explore NEAR Protocol indexer structures, including blocks, shards, chunks, transactions, receipts, execution outcomes, and state changes."
---
...
Don't skip the article about the [NEAR Data Flow](/protocol/data-flow/near-data-flow)
