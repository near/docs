...
To access the data provided by [NEAR Lake](../../lake-framework/near-lake.md) you need to provide valid AWS credentials in order to be charged by the AWS for the S3 usage.

:::info AWS credentials

Please note that using your own AWS Credentials is the only way to access the data provided by [NEAR Lake](../../lake-framework/near-lake.md) ecosystem.
