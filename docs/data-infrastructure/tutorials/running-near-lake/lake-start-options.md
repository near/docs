...
description: "Learn how to create a NEAR Lake Framework indexer with flexible start options: from a specific block, the latest final block, or resuming after an interruption."
---
