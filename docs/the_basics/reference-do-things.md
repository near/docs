...
See more about `contractContext` in [autogenerated docs](../client-api/ts/classes/context.md).
...
See [the storage docs](../client-api/ts/classes/storage.md) for the full reference.
...
Mathematical operations in TypeScript are done the same way as JavaScript. See more in [this article](https://www.tutorialspoint.com/typescript/typescript_arithmetic_operators_examples.htm).
