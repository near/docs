...
Go to our wallet faucet: [https://wallet.testnet.near.org](https://wallet.testnet.near.org/) <img src="../assets/icon-link.png" alt="^" style="display: inline; width: 0.8rem;"/> , enter a username, and click create account.
