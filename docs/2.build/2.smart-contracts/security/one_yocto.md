...
transferring of valuable assets like [NFTs](../../../2.build/relevant-contracts/nft.md) or [FTs](../../../2.build/relevant-contracts/ft.md). In such cases, you need to ensure that
