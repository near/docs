...
When a user [signs in on a website](../../4.building-web3-applications/frontend.md#user-sign-in) to interact with your contract, what actually happens is
...
transferring of valuable assets like [NFTs](../../../2.develop/relevant-contracts/nft.md) or [FTs](../../../2.develop/relevant-contracts/ft.md). In such cases, you need to ensure that
