...
We have an [RPC method for viewing account](/docs/develop/front-end/rpc#view_account).
...
- See API documentation for [discovering gas price via RPC here](/docs/develop/front-end/rpc#gas-price). 
...
See related [RPC interface for fetching transaction status here](/docs/develop/front-end/rpc#transaction-status). 
