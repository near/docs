...
You can test the storage used using the [SDK environment](../../2.build/2.building-smart-contracts/anatomy-of-a-contract/environment.md) and checking `env.storage_usage()`
