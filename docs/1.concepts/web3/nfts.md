...
4. Cost of a privately hosted indexer (if it’s used). More information can be found [here](https://github.com/near/near-indexer-for-explorer), a rough estimation for the costs is about 100$ per month.
