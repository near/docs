...
- workspaces - you can start your own local network to perform e2e testing. More info [here](../../2.build/2.building-smart-contracts/test-the-contract/integration-test.md).
