...
* Basic familiarity with [AssemblyScript (a strict subset of TypeScript)](https://www.typescriptlang.org/docs/handbook/typescript-in-5-minutes.html) will be helpful
