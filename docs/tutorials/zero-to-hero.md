...
Navigate to our API [storage docs](https://near.github.io/near-sdk-as/classes/_assembly_sdk_storage_.storage.html) to review the `setString` and `getString` functions. In later steps we'll show you how to handle more complicated data types.
