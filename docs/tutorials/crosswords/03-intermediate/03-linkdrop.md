...
import createMainnetAccount from '/assets/docs/crosswords/create-mainnet-account.png';
import createTestnetAccount from '/assets/docs/crosswords/create-testnet-wallet-account.png';
