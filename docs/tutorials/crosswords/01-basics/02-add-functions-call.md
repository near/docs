...
import teachingDeployment from '/assets/docs/tutorials/crosswords/teaching--jeheycell.near--artcultureac.jpeg';
import createAccount from '/assets/docs/tutorials/crosswords/creating account with text--seanpineda.near--_seanpineda.png';
import chalkboardErase from '/assets/docs/tutorials/crosswords/erasing-subaccount-chalkboard--iambon.near--JohnreyBona.mp4';
