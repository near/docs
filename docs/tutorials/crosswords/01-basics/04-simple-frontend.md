...
import nearReactFriends from '/assets/docs/crosswords/near-and-react--dakila.near--rodolf_dtbbx.png';
...
![Crossword puzzle frontend showing a filled out puzzle with clues on the right sidebar](/assets/docs/crosswords/basics-final-frontend.png)
