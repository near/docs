...
import chapter1Correct from '/assets/docs/tutorials/crosswords/chapter-1-crossword-correct.gif';
import accessKeys from '/assets/docs/tutorials/crosswords/keys-cartoon-good--alcantara_gabriel.near--Bagriel_5_10.png';
import functionCallAction from '/assets/docs/tutorials/crosswords/function-call-action.png';
import tutorialAccessKeys from '/assets/docs/tutorials/crosswords/access-keys.png';
...
Let's look at this `testnet` account that has one full-access key and two function-call access keys. As you can see, we use the [NEAR CLI](../../../tools/cli.md) to print this info.
