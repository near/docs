...
*Defined in [key_stores/browser_local_storage_key_store.ts:6](https://github.com/nearprotocol/nearlib/blob/12d9667/src.ts/key_stores/browser_local_storage_key_store.ts#L6)*