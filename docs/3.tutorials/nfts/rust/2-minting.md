...
In the [next tutorial](/tutorials/nfts/rust/upgrade-contract), you'll find out how to deploy a patch fix and what that means so that you can view your NFTs in the wallet.
