...
This article will show you how to use an existing [FT smart contract](https://docs.near.org/tutorials/fts/skeleton), and you'll learn [how to mint](#minting-your-fts) fungible tokens and [view them](#checking-your-wallet) in your Wallet.
