...
While somewhat advanced, you can learn more about [changing the serialization here](https://near-sdk.io/contract-interface/serialization-interface#overriding-serialization-protocol-default).
:::
