...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="contract.ts" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/src/contract.ts#L23-L30"
                start="23" end="30" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Github fname="lib.rs" language="rust"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/src/lib.rs#L33-L53"
                start="33" end="53" />
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="contract.ts" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/src/contract.ts#L57"
                start="57" end="57" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Github fname="lib.rs" language="rust"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/src/lib.rs#L56"
                start="56" end="56" />
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="contract.ts" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/src/contract.ts#L62"
                start="62" end="62" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Github fname="lib.rs" language="rust"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/src/lib.rs#L62-L63"
                start="62" end="63" />
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="contract.ts" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/src/contract.ts#L64-L67"
                start="64" end="67" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Github fname="lib.rs" language="rust"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/src/lib.rs#L75-L78"
                start="75" end="78" />
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Language value="javascript" language="javascript">
            <Github fname="call" 
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/src/contract.ts#L69-L75"
                start="69" end="75" />
            <Github fname="callback" 
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/src/contract.ts#L78-L81"
                start="78" end="81" />
        </Language>
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Language value="rust" language="rust">
            <Github fname="lib.rs" 
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/src/lib.rs#L81-L84"
                start="81" end="84" />
            <Github fname="ext.rs" 
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/src/ext.rs#L8-L11"
                start="8" end="11" />
        </Language>
        ...
        <Github fname="lib.rs" language="rust"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/src/lib.rs#L86"
                start="86" end="86" />
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="contract.ts" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/src/contract.ts#L49-L53"
                start="49" end="53" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Github fname="lib.rs" language="rust"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/src/lib.rs#L99-L109"
                start="99" end="109" />
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="main.ava.js" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/sandbox-test/main.ava.js#L28-L29"
                start="28" end="29" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Github fname="test_basics.rs" language="rust"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/tests/test_basics.rs#L33-L46"
                start="33" end="46" />
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="main.ava.js" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/sandbox-test/main.ava.js#L50-L53"
                start="50" end="53" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Github fname="test_basics.rs" language="rust"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/tests/test_basics.rs#L81-L97"
                start="81" end="97" />
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="main.ava.js" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/sandbox-test/main.ava.js#L56-L57"
                start="56" end="57" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Language value="rust" language="rust">
            <Github fname="Call ft_transfer" 
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/tests/test_basics.rs#L100-L107"
                start="100" end="107" />
            <Github fname="ft_transfer definition" 
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/tests/test_basics.rs#L291-L307"
                start="291" end="307" />
        </Language>
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="main.ava.js" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/sandbox-test/main.ava.js#L101-L104"
                start="101" end="104" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Language value="rust" language="rust">
            <Github fname="Call ft_transfer_call" 
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/tests/test_basics.rs#L149-L161"
                start="149" end="161" />
            <Github fname="ft_transfer_call definition" 
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/tests/test_basics.rs#L322-L337"
                start="322" end="337" />
        </Language>
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="main.ava.js" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/sandbox-test/main.ava.js#L106-L109"
                start="106" end="109" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Language value="rust" language="rust">
            <Github fname="Call ft_balance_of" 
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/tests/test_basics.rs#L163-L166"
                start="163" end="166" />
            <Github fname="ft_balance_of definition" 
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/tests/test_basics.rs#L309-L320"
                start="309" end="320" />
        </Language>
...
<Tabs groupId="code-tabs">
    ...
    <TabItem value="js" label="🌐 JavaScript">
        ...
        <Github fname="main.ava.js" language="javascript"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-ts/04-ft-owner-claims-winner-gets-nft/sandbox-test/main.ava.js#L122-L130"
                start="122" end="130" />
    ...
    <TabItem value="rust" label="🦀 Rust">
        ...
        <Github fname="test_basics.rs" language="rust"
                url="https://github.com/near-examples/auctions-tutorial/blob/reorg-auction/contract-rs/04-ft-owner-claims-winner-gets-nft/tests/test_basics.rs#L190-L207"
                start="190" end="207" />
