...
You can use [`styled-components`](../../2.build/3.near-components/anatomy-of-a-component/builtin-components.md) in combination with Radix UI primitives. Here's an example:
