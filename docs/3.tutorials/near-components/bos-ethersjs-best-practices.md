...
You can see how it works here: [step_1](https://dev.near.org/near/widget/ComponentDetailsPage?src=zavodil.near/widget/token-balances-step-1&tab=source).
...
You can see how it works here: [step_2](https://dev.near.org/near/widget/ComponentDetailsPage?src=zavodil.near/widget/token-balances-step-2&tab=source).
...
Here is an example of a simple application for [setting tokens list in social-db](https://dev.near.org/near/widget/ComponentDetailsPage?src=zavodil.near/widget/tokens-db&tab=source). 
...
You can see how it works here: [step_3](https://dev.near.org/near/widget/ComponentDetailsPage?src=zavodil.near/widget/token-balances-step-3&tab=source). The output of the data in the application remains unchanged, but now it no longer contains hardcoded values.
...
You can see how it works here: [step_4](https://dev.near.org/near/widget/ComponentDetailsPage?src=zavodil.near/widget/token-balances-step-4&tab=source). The output of the data in the application remains the same, but now it operates more efficiently.
