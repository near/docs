...
In this article you'll learn how to create a NEAR component that gathers information from a [QueryAPI indexer](../../2.build/6.near-data-infrastructure/query-api/intro.md) using WebSockets.
...
[QueryAPI](../../2.build/6.near-data-infrastructure/query-api/intro.md) is a fully managed solution to build indexer functions, extract on-chain data, store it in a database, and be able to query it using GraphQL endpoints.
...
Learn more about [QueryAPI indexing functions](../../2.build/6.near-data-infrastructure/query-api/index-function.md) and how to build your own indexers.
