...
#### `createPost`
Creating a post is done by using the [`context.db.Posts.insert()`](../../../2.build/6.near-data-infrastructure/query-api/context.md#insert) function:
...
Creating a comment is done by using the [`context.db.Comments.insert()`](../../../2.build/6.near-data-infrastructure/query-api/context.md#insert) function:
