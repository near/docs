...
This is solved easily by using the [`context.db.Nfts.insert`](../../../2.build/6.near-data-infrastructure/query-api/context.md#insert) helper method:
