...
description: "Explore Omni Bridge's technical architecture, covering token factory patterns, MPC signing, security models, relayers, and cross-chain transfers."
---
