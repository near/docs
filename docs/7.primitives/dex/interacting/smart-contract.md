...
:::note
- In order to swap tokens on Ref Finance your account must have enough token balance on Ref Finance.
- In order to hold FTs your account must be registered on FT contract.
:::