...
### How do I become a validator? {#how-do-i-become-a-validator}

You need an account with sufficient amount of funds.
Follow the docs [here](/docs/validator/staking) to understand how to become a validator, and [here](/docs/develop/node/validator/running-a-node) to run a node.
...
### What is a minimum amount to stake as a validator? {#what-is-a-minimum-amount-to-stake-as-a-validator}
...
### What is a slashing behavior? {#what-is-a-slashing-behavior}
...
### Is NEAR enforcing liveness fault slashing? {#is-near-enforcing-liveness-fault-slashing}
...
### What are the responsibilities of a validator? {#what-are-the-responsibilities-of-a-validator}
...
### Can I stake on a different shard? {#can-i-stake-on-a-different-shard}
...
### Do validators receive incentives for testing the protocol? {#do-validators-receive-incentives-for-testing-the-protocol}
...
### How does delegating staking works? {#how-does-delegating-staking-works}
...
### Where can I find the neardev/ folder? {#where-can-i-find-the-neardev-folder}
*Last updated: ???*

Once you run 'near login', a folder, called 'neardev', will be created in the directory in which you ran 'near login'.

### Can I be a validator on the TestNet network? {#can-i-be-a-validator-on-the-testnet-network}
*Last updated: ???*
...
### Why did my node get kicked-out of the validation process on BetaNet? {#why-did-my-node-get-kicked-out-of-the-validation-process-on-betanet}
*Last updated: ???*
...
### After logging in using NEAR CLI with 'near login', I always receive an error message “Exceeded 10 status check attempts.” How should I solve this? {#after-logging-in-using-near-cli-with-near-login-i-always-receive-an-error-message-exceeded-10-status-check-attempts-how-should-i-solve-this}
*Last updated: ???*

This means that something is broken in the wallet, please reach out to us on Slack for troubleshooting.

### Could someone permissionlessly delegate to me as a validator? {#could-someone-permissionlessly-delegate-to-me-as-a-validator}
...
### My stake has been delegated but rewards aren't showing up. How do I see them? {#my-stake-has-been-delegated-but-rewards-arent-showing-up-how-do-i-see-them}
