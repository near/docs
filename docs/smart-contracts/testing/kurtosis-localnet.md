...
![Local wallet landing page](/assets/docs/smart-contracts/local-wallet-landing-page.png)
...
![Local explorer sending 1 NEAR](/assets/docs/smart-contracts/local-explorer-send-funds.png)
...
![Localnet explorer](/assets/docs/smart-contracts/localnet-explorer.png)
...
![Local explorer contract deployed](/assets/docs/smart-contracts/local-explorer-contract-deployed.png)
...
![Local wallet collectibles tab](/assets/docs/smart-contracts/local-wallet-collectibles-tab.png)
...
![Local dApp build](/assets/docs/smart-contracts/local-dapp-build.png)
...
![Local Guest Book Landing Page](/assets/docs/smart-contracts/local-guest-book-landing.png)
...
![Local Guest Book Signed Message](/assets/docs/smart-contracts/local-guest-book-signed-message.png)
...
![Local Explorer Signed Transaction](/assets/docs/smart-contracts/local-explorer-signed-transaction.png)
