...
You can use [Storage](https://near.github.io/near-sdk-as/classes/_assembly_sdk_storage_.storage) or collections (described below). These are pretty raw in terms of documentation because they are under heavy development.
