...
During the whole cycle, developers can choose between [JavaScript](https://www.learn-js.org/) and [Rust](https://www.rust-lang.org/), and [Go](https://go.dev/), allowing them to use their favorite language at each step of their journey.

<Warning>
We **strongly recommend using [Rust](https://www.rust-lang.org/)** for production contracts. Rust offers the most mature tooling, best performance, and the strongest safety guarantees when dealing with real assets on-chain. JavaScript, Python, and Go are great for prototyping and learning, but Rust is the right choice when it matters.
</Warning>
