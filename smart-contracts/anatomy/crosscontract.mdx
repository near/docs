...
We have a whole [security section](/smart-contracts/security/cross-contract-calls/callbacks) dedicated to these specific errors, so please go and check it.

<Warning>
Not following these basic security guidelines could expose your contract to exploits. Please check the [security section](/smart-contracts/security/cross-contract-calls/callbacks), and if still in doubt, [join us in Discord](https://near.chat).
</Warning>
