...
<Block highlights="6,13,22,27" fname="hello-near">
...
<Block highlights="1,15,24,81" fname="auction" type='info'>
...
<Block highlights="6-9" fname="auction">

    ### Complex Objects
    Smart contracts can store and return complex objects

    <Note>
    Objects will always be received and returned as JSON.
    </Note>

</Block>

<Block highlights="4" fname="auction">
...
<Block highlights="8,28,45" fname="auction">
...
<Block highlights="7,46" fname="auction">
