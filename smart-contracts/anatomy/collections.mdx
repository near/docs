...
<Tabs>
  ...
  If you see a compiler error like `unresolved import near_sdk::BorshIntoStorageKey`, your code is following an outdated pattern from `near-sdk < 4.0`. Derive [`BorshStorageKey`](https://docs.rs/near-sdk/latest/near_sdk/derive.BorshStorageKey.html) on your prefix enum instead — `BorshIntoStorageKey` is now an internal trait that the derive implements for you.
