...
description: "Avoid predictable randomness vulnerabilities"
---
...
1. [Frontrunning](./frontrunning), which we cover in another page
2. Gaming the input
...
probability of winning from `1/2` to `3/4`, that's a 50% relative increase!

These odds, of course, dilute in games with more possible outcomes.

<Accordion title="How does the math work here?">
