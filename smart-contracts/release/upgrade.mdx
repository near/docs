...
<CodeGroup>
  ...
  <Github fname="main.go"
        url="https://github.com/Emir-Asanov/near-go-examples/blob/example-release-1/self-update/main.go"
        start="10" end="53" />
...
<Github fname="main.go"
      url="https://github.com/Emir-Asanov/near-go-examples/blob/example-release-1/guest-book/base/main.go"
      start="12" end="28" />
...
<Github fname="main.go"
      url="https://github.com/Emir-Asanov/near-go-examples/blob/example-release-1/guest-book/v2/main.go"
      start="14" end="26" />
