...
# Install TinyGo (required to compile contracts to WASM)
# See https://tinygo.org/getting-started/install/ for platform-specific instructions
brew install tinygo  # macOS
# or: snap install tinygo  # Linux (snapd)
...
<Tabs>
  ...
  <Tab title="🐹 GO">
    <Github fname="main.go" language="go"
            url="https://github.com/Emir-Asanov/near-go-examples/blob/example-release-1/auction/main.go"
            start="11" end="40" />
  </Tab>
</Tabs>
