...
<Warning>
We **strongly recommend using [Rust](https://www.rust-lang.org/)** for production contracts. FT contracts manage real economic value — Rust's safety guarantees and mature tooling make it the right choice when it matters.
</Warning>
