...
Global contracts can be deployed using [`NEAR CLI`](./tutorials/factories/global-contracts#deployment) or by code using [NEAR APIs](../tools/near-api#deploy-a-global-contract). Check [this tutorial](./tutorials/factories/global-contracts) to learn how to deploy and use Global Contracts using CLI, JavaScript, or Rust.
