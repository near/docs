  ...
  <Tab title="Web App">
    <Columns cols={2}>
      <div>
        ...
        <Card title="Wallet authentication" icon="wallet" href="/web3-apps/tutorials/wallet-login" horizontal arrow>
          Connect wallets, handle sessions, and manage user accounts.
        </Card>
        <Card title="Data types reference" icon="book-open" href="/web3-apps/tutorials/data-types" horizontal arrow>
