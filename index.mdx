  ...
  <Tab title="Web App">
    <Columns cols={2}>
      <div>
        ...
        <Card title="Wallet Login" icon="wallet" href="/web3-apps/concepts/web-login" horizontal arrow>
          Connect wallets via NEAR Connect — secure, zero-dependency, 10+ wallets supported.
        </Card>
        <Card title="Social Login" icon="user" href="/web3-apps/concepts/social-login" horizontal arrow>
          Let users sign in with email or social accounts via Privy.
        </Card>
