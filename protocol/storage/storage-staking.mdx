...
2. Visitors to your app can add messages to the guest book. This means your users will, [by default](/protocol/transactions/gas#understanding-gas-fees), pay a small gas fee to send their message to your contract.
