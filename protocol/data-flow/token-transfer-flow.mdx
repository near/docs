...
If you don't know what **Gas** is, please [first read the article about Gas](/protocol/transactions/gas) from our docs.

As for *Refunds*, here's a quote from the [Gas](/protocol/transactions/gas) article:
...
> ...
>
> *From NEAR Protocol docs [Gas. Attach extra gas; get refunded!](/protocol/transactions/gas)*
