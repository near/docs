...
Learn how to run it following the [tutorial](./tutorials/near-indexer).

</Tip>

---

## Comparison with [NEAR Lake Framework](/data-infrastructure/lake-framework/near-lake)
...
Decentralized | **Yes** | No<br />(Aurora dumps the blocks to AWS S3)
...
Estimated cost of infrastructure | [$500+/mo](https://near-nodes.io/rpc/hardware-rpc) | **$20/mo**
...
Ease of local development | Advanced<br />(localnet is a good option, but testing on testnet/mainnet is too heavy) | **Easy**<br />(see [running Lake Indexer](/data-infrastructure/tutorials/running-near-lake/run-near-lake))
