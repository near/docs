...
## What's next?
You can learn more about the [Lake Indexer project](./lake-framework/near-lake) (note: deprecated since March 24, 2026). For new projects, see [Neardata](https://neardata.xyz) and the [NEAR Indexer tutorial](/data-infrastructure/tutorials/near-indexer) to learn how to build an indexer in practice.
