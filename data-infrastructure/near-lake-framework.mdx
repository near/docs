...
As of **March 24, 2026**, the NEAR Lake (AWS S3 buckets) has stopped indexing new blocks and is no longer maintained by Aurora. Existing data remains accessible, but no new blocks will be written.
...
- **[Data APIs](./data-api)** — community APIs from [NearBlocks](https://nearblocks.io), [Pikespeak](https://pikespeak.ai), and [FastNear](https://fastnear.com)
- **[Goldsky](https://goldsky.com)** — managed indexer service
- **[Nearcore Indexer](./near-indexer)** — run your own indexer node
