...
We will use Python version of [NEAR Lake Framework](https://pypi.org/project/near-lake-framework) in this tutorial. Though the concept is the same for Rust, but we want to show more people that it's not that complex to build your own indexer.
...
Mintbase turn, we hope [Nate](https://twitter.com/nategeier) and his team have migrated to [NEAR Lake Framework](https://pypi.org/project/near-lake-framework) already, saying "Hi!" and crafting the link:
