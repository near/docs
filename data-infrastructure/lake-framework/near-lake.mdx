...
[Aurora](https://aurora.dev) runs NEAR Lake nodes to store the data in JSON format on AWS S3.
You can read directly from these S3 buckets (paying for your own AWS access) without running your own NEAR Lake, unless you have specific reasons to do that.
